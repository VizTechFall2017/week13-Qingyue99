...
d3.csv("2chart.csv",
    ...
    x3.domain(data.map(function(d) { return d.item; }));
    ...
    var tooltip = svg.append("g")
        ...
        .attr("fill", function(d) {
            console.log("zx1111111");
            console.log(zx(d.key));

            return zx(d.key); })
        .selectAll("rect")
        .data(function(d) { return d; })
        .enter().append("rect")
        .attr("x", function(d) { return x3(d.data.item); })
